    ...
    <S.Container onClick={() => handleOpen}>
      ...
      <S.DataContainer>
        <S.CNHRegisterBox>
          ...
          <S.CNHRegisterInput
            id="driverLicense.register"
            value={formik.values.driverLicense.register}
            onChange={formik.handleChange}
          />
        </S.CNHRegisterBox>
        <S.CNHRegisterBox>
        ...
        <S.CNHRegisterBox>
          ...
          <S.CNHRegisterInput
            id="driverLicense.points"
            value={formik.values.driverLicense.points}
            onChange={formik.handleChange}
          />
        </S.CNHRegisterBox>
        <S.CNHRegisterBox>
          ...
          <S.CNHRegisterPhoto
            type="driverLicense.photoDriverLicense"
            name="driverLicense.photoDriverLicense"
            id="driverLicense.photoDriverLicense"
            value={formik.values.driverLicense.photoDriverLicense}
            onChange={formik.handleChange}
          />
        </S.CNHRegisterBox>
        <S.CategoryBox>
