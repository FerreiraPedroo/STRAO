...
export const Window = () => {
  ...
  const handleMoveWindows = () => {
    const addMove = (event) => {
      ...
      if (
        !(x <= sizeWindow.x / 2 + 5) &&
        !(x >= event.view.innerWidth - sizeWindow.x / 2 - 15)
      ) {
  ...
  return (
    ...
    >
      <W.TitleContainer>
        ...
        <W.TitleText onMouseDown={(event) => handleMoveWindows(event)}>
          {" "}
          Painel de Controle
        </W.TitleText>
        <W.ButtonBox>
      ...
      <W.BodyContainer sizeWindow={sizeWindow}>
        <W.Text>
          Pedro Henrique de assis ferreiraedro henrique -------- Pedro Henrique
          de assis ferreira do nascimento pedro henrique -------- Pedro Henrique
          de assis ferreiranascimento pedro henrique -------- Pedro Henrique de
          assis ferreira henrique -------- Pedro Henrique d do nascimento pedro
          henrique --------
        </W.Text>
      </W.BodyContainer>
